// Ensure the BASE_API_URL is set to your deployed backend URL.
// It is currently set to "https://dansog-backend.onrender.com/api".
// If this is incorrect, please update it here.
// No changes needed if this URL is correct.
...
async function handleLoginForm(event) {
  ...
  try {
    ...
    setTimeout(() => {
      ...
      window.location.href = "pin-verify-login.html" // Changed from /pin-verify-login
    }, 1000)
  } catch (error) {
...
async function handleSignupForm(event) {
  ...
  try {
    ...
    setTimeout(() => {
      window.location.href = "signup-otp.html" // Changed from /signup-otp
    }, 1500)
  } catch (error) {
...
async function handleOtpVerifyForm(event) {
  ...
  if (!tempSignupData.email) {
    ...
    window.location.href = "signup.html" // Changed from /signup
    return
  }
  ...
  try {
    ...
    setTimeout(() => {
      window.location.href = "create-pin.html" // Changed from /create-pin
    }, 1500)
  } catch (error) {
...
async function handleCreatePinForm(event) {
  ...
  if (!tempSignupData || !tempSignupData.email) {
    ...
    setTimeout(() => (window.location.href = "signup.html"), 2000) // Changed from /signup
    return
  }
  ...
  try {
    ...
    setTimeout(() => (window.location.href = "index.html"), 2000) // Changed from /
  } catch (error) {
...
async function handlePinVerifyLoginForm(event) {
  ...
  try {
    ...
    window.location.href = "dashboard/index.html" // Changed from /dashboard
  } catch (error) {
...
async function handleForgotPasswordForm(event) {
  ...
  try {
    ...
    setTimeout(() => {
      window.location.href = "forgot-password-otp.html" // Changed from /forgot-password-otp
    }, 1500)
  } catch (error) {
...
async function handleForgotPasswordOtpVerifyForm(event) {
  ...
  if (!email) {
    ...
    setTimeout(() => (window.location.href = "forgot-password.html"), 2000) // Changed from /forgot-password
    return
  }
  ...
  try {
    ...
    setTimeout(() => {
      window.location.href = "new-password.html" // Changed from /new-password
    }, 1500)
  } catch (error) {
    console.error("❌ OTP verification failed:", error) // Add console log
    showToast("OTP verification failed: " + error.message, "error")
...
async function handleNewPasswordForm(event) {
  ...
  setTimeout(() => (window.location.href = "index.html"), 1500) // Changed from /
}
...
async function handlePinResetForm(event) {
  ...
  try {
    ...
    setTimeout(() => {
      window.location.href = "pin-reset-otp.html" // Changed from /pin-reset-otp
    }, 1500)
  } catch (error) {
...
async function handlePinResetOtpVerifyForm(event) {
  ...
  if (!email) {
    ...
    setTimeout(() => (window.location.href = "pin-reset.html"), 2000) // Changed from /pin-reset
    return
  }
  ...
  try {
    ...
    setTimeout(() => {
      window.location.href = "set-new-pin.html" // Changed from /set-new-pin
    }, 1500)
  } catch (error) {
    console.error("❌ OTP verification failed:", error) // Add console log
    showToast("OTP verification failed: " + error.message, "error")
...
function handleLogoutButton() {
  ...
  window.location.href = "index.html" // Changed from /
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // New Password Page
  if (currentPage === "new-password.html") {
  ...
  // PIN Reset OTP Page
  if (currentPage === "pin-reset-otp.html") {
  ...
  // Set New PIN Page
  if (currentPage === "set-new-pin.html") {
