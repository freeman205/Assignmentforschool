...
async function handleOtpVerifyForm(event) {
  ...
  const otpCode = document.getElementById("otp").value // Corrected ID
...
async function handleCreatePinForm(event) {
  ...
  const newPin = document.getElementById("pin").value // Corrected ID
  const confirmNewPin = document.getElementById("confirm-pin").value // Corrected ID
...
async function handleNewPasswordForm(event) {
  ...
  const newPassword = document.getElementById("new-password").value // Corrected ID
  const confirmNewPassword = document.getElementById("confirm-password").value // Corrected ID
  const email = sessionStorage.getItem("forgotPasswordEmail")
...
async function handleSetNewPinForm(event) {
  ...
  const newPin = document.getElementById("new-pin").value // Corrected ID
  const confirmNewPin = document.getElementById("confirm-new-pin").value // Corrected ID
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Signup OTP Page
  const signupOtpVerifyForm = document.getElementById("otp-form") // Corrected ID
  if (signupOtpVerifyForm) {
    signupOtpVerifyForm.addEventListener("submit", handleOtpVerifyForm)
    const resendOtpButton = document.getElementById("resend-otp-button") // Corrected ID
    if (resendOtpButton) {
  ...
  const forgotPasswordOtpVerifyForm = document.getElementById("forgot-password-otp-form") // Corrected ID
  ...
  const pinVerifyLoginForm = document.getElementById("pin-verify-form") // Corrected ID
  ...
  // PIN Reset OTP Page
  const pinResetOtpVerifyForm = document.getElementById("pin-reset-otp-form") // Corrected ID
...
// Expose utility functions globally for dashboard.js
