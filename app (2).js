...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // This condition ensures it only attaches if not on dashboard.html, as dashboard.js will handle its own logout.
  if (universalLogoutButton && !window.location.pathname.endsWith("dashboard.html")) {
    universalLogoutButton.addEventListener("click", handleLogoutButton)
  }
})
...
window.handleLogoutButton = handleLogoutButton // Expose handleLogoutButton for dashboard.js
